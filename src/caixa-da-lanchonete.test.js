...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['debito', 'R$ 6,00', ['cafe,1', 'chantily,2']],
    ])('compra simples em %p deve resultar em %p', validaTeste);

    test.each([
        ['cafe e um código inexistente ', 'dinheiro', 'Item inválido!', ['cafe,1', 'pizza,1']],
        ['com um código inexistente', 'debito', 'Quantidade de item inválido!', ['cafe,-2']],
        ['com um código inexistente', 'debito', 'Item inválido!', ['-2']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
